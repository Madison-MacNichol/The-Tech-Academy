...
&nbsp;&nbsp;<asp:Button ID="addButton" runat="server" OnClick="addButton_Click" Text="Add" type="submit" data-bind="enable: itemToAdd().length > 0"/>
	...
	<p>Your List:</p>
		<asp:ListBox ID="groceryList" runat="server"  multiple="multiple" data-bind="options:allItems, selectedOptions:selectedItems"  style="width: 616px; height: 160px"></asp:ListBox>
&nbsp;
