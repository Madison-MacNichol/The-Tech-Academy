...
<body>
    <form id="form1" runat="server">
        <div>
			...
			<br />
			<br />
			<asp:RadioButton ID="groundRadioButton" runat="server" AutoPostBack="True" OnCheckedChanged="groundRadioButton_CheckedChanged" Text="Ground" />
			<br />
			<asp:RadioButton ID="airRadioButton" runat="server" AutoPostBack="True" OnCheckedChanged="airRadioButton_CheckedChanged" Text="Air" />
			<br />
			<asp:RadioButton ID="nextDayRadioButton" runat="server" AutoPostBack="True" OnCheckedChanged="nextDayRadioButton_CheckedChanged" Text="Next Day" />
			<br />
			<br />
